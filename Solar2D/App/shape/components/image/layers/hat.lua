...
local layerProps = {
  blendMode = "",
  height    =  389.57468455218 - 197.57468455218,
  width     = 1075.7262443439 - 824.72624434389 ,
  kind      = "image",
  name      = "hat",
  type      = "png",
  x         = 1075.7262443439 + (824.72624434389 -1075.7262443439)/2,
  y         = 197.57468455218 + (389.57468455218 - 197.57468455218)/2,
