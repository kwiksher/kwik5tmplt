-------------------------------------------------------------------------------
-- Retreat Scene View - BTree Implementation
-------------------------------------------------------------------------------
...
local layout = {
    background = "images/bg_retreat.png",
}
...
function scene:create(event)
    ...
    local uiElements = displayManager.createDialogueInterface(self.objs.uiGroup, {
        onRelease = function()
            ...
            print("Retreat scene: Next button pressed")
        end,
    })
    ...
    if self.objs.dialogueText then
        self.objs.dialogueText.text = "RETREAT SCENE - You slowly back away toward the safety of the cabin..."
    end
end

function scene:show(event)
    if event.phase == "will" then
        print("Retreat scene showing")
    elseif event.phase == "did" then
        print("Retreat scene visible")
    end
end

function scene:hide(event)
    if event.phase == "will" then
        print("Retreat scene hiding")
        -- Clean up audio
        audio.stop()
    end
end
