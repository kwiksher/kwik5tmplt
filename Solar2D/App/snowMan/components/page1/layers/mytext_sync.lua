...
local M = {
  ...
  properties = {
    target       = "mytext",
    autoPlay     = true,
    backgroundRectColor = { 0.99607843137255, 0.9921568627451, 0.9921568627451, 0.4 },
    delay        = 0,
    fadeDuration = 1000,
    langClassDelegate = false,
    speakerIcon = true,
    speakerIconColor =  { 0, 1, 0, 1 },
    wordTouch   = false,
  },
  audioProps = {
  ...
  textProps = {
    ...
    folder       = nil,
    font         = "",
    fontColor   =  { 0.4156862745098, 0.58039215686275, 0.84705882352941, 1 },
    fontColorHi =  { 0.39607843137255, 0.39607843137255, 0.29411764705882, 1 },
    fontSize    = 24,
    language    = "",
    padding     = 10,
    readDir     = "leftToRight",
