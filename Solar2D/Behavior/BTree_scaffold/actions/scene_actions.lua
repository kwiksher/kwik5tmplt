...
local function gotoScene(sceneName)
    ...
    if useComponentPaths then
        targetScene = "App.BTree_scaffold.components." .. baseName .. ".index"
    else
        targetScene = "Behavior.BTree_scaffold.views." .. baseName .. "." .. sceneName
    end
...
local function nextScene()
    ...
    composer.gotoScene("Behavior.BTree_scaffold.views.emptyScene", {
        effect = "slideLeft",
        time = 300,
        params = params
    })
