...
function M:create (UI)
  ...
  elseif self.properties.url:find(".lua") then
    ...
    print("Error reading",self.properties.url)
  end

  emitterParams.textureFileName = UI.props.particleDir .. emitterParams.textureFileName
  --
  --printKeys(emitterParams)
